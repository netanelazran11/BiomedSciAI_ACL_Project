#!/bin/bash -l
#SBATCH --job-name=pretrain-valueonly-methylation-8k
...
WANDB_PROJECT="pretrain-valueonly-bmfm-rna-methylation-8k"
WANDB_RUN_NAME="valueonly-pretrain-${SLURM_JOB_ID}"
