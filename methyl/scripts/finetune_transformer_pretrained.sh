#!/bin/bash -l
#SBATCH --job-name=finetune-pretrained-8k
...
# Pretrained checkpoint from value-only pretraining (job 44010077)
CHECKPOINT="/sci/labs/benjamin.yakir/netanel.azran/repos/BMFM-RNA/methyl/outputs/pretrain-valueonly-bmfm-rna-methylation-8k/valueonly-pretrain-44010077/pretrain_valueonly/checkpoints/epoch=epoch=14-val_loss=validation/loss=0.1034.ckpt"

# W&B naming
WANDB_ENTITY="netanelazran11-hebrew-university-of-jerusalem"
WANDB_PROJECT="transformer-valueonly-finetune-bmfm-rna-methylation-8k"
WANDB_RUN_NAME="finetune-pretrained-${SLURM_JOB_ID}"
...
# -------------------------
# Run Value-Only Transformer Fine-tuning (FROM PRETRAINED)
# -------------------------
